...
A desktop app for tracking your standings on [ATGames ArcadeNet](https://www.atgames.net/leaderboards/titles) pinball leaderboards. Fetches the top 50 scores for every game, shows your personal rankings (even beyond top 50), surfaces the targets you can chase, and tells you what has changed since your last session.

## Features

- **ArcadeNet login** via browser for full access to your personal data
- **Personal rankings beyond top 50** — scores and ranks for every game you've played
...
- **Next-Target guidance** — shows what it takes to enter the Top 50 / 10 or become #1, with exact point gap
...
Use the **MY GAMES / ALL GAMES / TOURNAMENTS** toggle to switch views. Click any card to see a detailed breakdown in the right panel: next targets, this-week / this-month leaders, and the full top-50 leaderboard with your own score pinned if you're outside the visible range.
...
2. Top 50 scores per game are fetched concurrently (pipelined with step 1)
